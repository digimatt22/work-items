...
| `16-client-list-desktop.png` | Client request list | Client | Search/filter, expand/collapse project groups, open visible request | Useful as a lower-density alternative to the board. Client no longer needs account-level navigation to understand the request set, and summary copy now uses request language. |
