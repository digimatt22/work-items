...
export const initialMcpToolContracts: readonly McpToolContract[] = [
  ...
  { name: "work_items.create", family: "work_items", requiredScope: "work_items:write" },
  {
    name: "work_items.change_status",
    family: "work_items",
    requiredScope: "work_items:status:write"
  },
  { name: "comments.create", family: "comments", requiredScope: "comments:write" },
  { name: "search.global", family: "search", requiredScope: "search:read" },
  { name: "summaries.generate", family: "summaries", requiredScope: "summaries:write" }
];
