...
import { ProjectPicker } from "../work-items/ProjectPicker";
...
const reportTypes: Array<{
...
}> = [
  {
    ...
    label: "Report Bug",
    description:
      "Something is broken, incorrect, confusing, or not working as expected.",
  },
  {
    value: "FEATURE",
    label: "Request a feature",
    description:
      "A new capability, improvement, workflow, or change would help your team.",
  },
];
    ...
    >
      ...
      <section className="rounded-2xl border border-line bg-surface p-4 shadow-card sm:p-5">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-muted">
          Choose the project, pick the kind of request, and add the details you
          have. Screenshots, logs, documents, and short videos are welcome.
        </p>
      </section>

      <section className="rounded-2xl border border-line bg-surface p-4 shadow-card sm:p-5">
        <ProjectPicker
          idPrefix="client-report"
          projects={projects}
      ...
      <section className="rounded-2xl border border-line bg-surface p-4 shadow-card sm:p-5">
        <div className="grid gap-4">
          ...
          <input
            ...
            placeholder={
              type === "BUG"
                ? "Example: Checkout page shows an error after clicking Submit"
                : "Example: Add a weekly project health email"
            }
            required
          />
          ...
          <textarea
            ...
            placeholder={
              type === "BUG"
                ? "Example: This started today around 2 PM. It happens for two people on Chrome after entering payment details."
                : "Example: Our managers need a weekly summary with open items, blockers, and decisions needed before Monday planning."
            }
            required
            rows={5}
          />
        ...
        {type === "BUG" ? (
          <div className="mt-6 grid gap-4 border-t border-line pt-5">
            ...
            <textarea
              ...
              placeholder="Example: 1. Open the client portal. 2. Go to Billing. 3. Click Submit."
              rows={3}
            />
            ...
            <textarea
              ...
              placeholder="Example: The invoice should save and show a confirmation message."
              rows={3}
            />
            ...
            <textarea
              ...
              id="actualBehavior"
              name="actualBehavior"
              placeholder="Example: A red error appears and the invoice does not save."
              rows={3}
            />
          </div>
        ) : (
          <div className="mt-6 grid gap-4 border-t border-line pt-5">
            ...
            <textarea
              ...
              id="userStory"
              name="userStory"
              placeholder="Example: As an operations manager, I want a weekly email summary so I can prepare for Monday planning."
              rows={3}
            />
            ...
            <textarea
              ...
              placeholder="Example: The email includes open bugs, active feature requests, blockers, and links to each item."
              rows={3}
            />
            ...
            <textarea
              ...
              id="businessValue"
              name="businessValue"
              placeholder="Example: Saves each manager 30 minutes per week and keeps launch blockers visible."
              rows={3}
            />
          </div>
        )}
      ...
      <section className="rounded-2xl border border-dashed border-line bg-[#fbfcff] p-4 sm:p-5">
        ...
        <p className="mt-2 text-xs leading-5 text-soft">
          Accepted examples: screenshots, PDFs, spreadsheets, logs, short
          videos, and zip files.
        </p>
      </section>
